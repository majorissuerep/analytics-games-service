-- Chess custom-model platform: registry, submissions, audit, deployments, arena matches.
-- The application also self-heals this schema at runtime via lib/chess-models/ensure-schema.ts.
